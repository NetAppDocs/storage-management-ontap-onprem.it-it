...
[role="lead"]
Se hai scoperto un cluster ONTAP on-premise utilizzando un agente Console, puoi creare volumi direttamente dalla NetApp Console, accedere a ONTAP System Manager (direttamente dalla Console) per una gestione avanzata e abilitare i servizi dati NetApp .
...
== Creare volumi FlexVol dalla NetApp Console
...
È possibile utilizzare l'API NetApp Console per creare volumi FlexGroup .  Un volume FlexGroup è un volume scalabile che garantisce prestazioni elevate insieme alla distribuzione automatica del carico.
...
== Accedi a ONTAP System Manager dalla NetApp Console
...
+
--
https://docs.netapp.com/us-en/bluexp-replication/task-replicating-data.html["Documentazione NetApp Replication"^]
...
+
--
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html["Documentazione NetApp Backup and Recovery"^]
...
+
--
https://docs.netapp.com/us-en/bluexp-classification/concept-cloud-compliance.html["Documentazione NetApp Data Classification"^]
...
+
--
https://docs.netapp.com/us-en/bluexp-tiering/concept-cloud-tiering.html["Documentazione NetApp Cloud Tiering"^]

--
Identificare i cluster con bassa capacità:: Identificare i cluster con bassa capacità e verificarne la capacità attuale e prevista.
+
--
